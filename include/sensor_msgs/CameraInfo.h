 ...
 * /tmp/buildd/ros-diamondback-common-msgs-1.4.0/debian/ros-diamondback-common-msgs/opt/ros/diamondback/stacks/common_msgs/sensor_msgs/msg/CameraInfo.msg
 */
...
struct CameraInfo_ : public ros::Message {
  ...
  typedef std::vector<
      double,
      typename ContainerAllocator::template rebind<double>::other>
      _D_type;
  std::vector<double,
              typename ContainerAllocator::template rebind<double>::other>
      D;
  ...
  ROS_DEPRECATED void get_D_vec(
      std::vector<double,
                  typename ContainerAllocator::template rebind<double>::other>&
          vec) const {
    vec = this->D;
  }
  ROS_DEPRECATED void set_D_vec(
      const std::vector<
          double,
          typename ContainerAllocator::template rebind<double>::other>& vec) {
    this->D = vec;
  }
 ...
 public:
  ...
  typedef boost::shared_ptr< ::sensor_msgs::CameraInfo_<ContainerAllocator> >
      Ptr;
  typedef boost::shared_ptr<
      ::sensor_msgs::CameraInfo_<ContainerAllocator> const>
      ConstPtr;
};  // struct CameraInfo
...
std::ostream& operator<<(
    std::ostream& s, const ::sensor_msgs::CameraInfo_<ContainerAllocator>& v) {
  ros::message_operations::Printer<
      ::sensor_msgs::CameraInfo_<ContainerAllocator> >::stream(s, "", v);
  return s;
}
...
struct MD5Sum< ::sensor_msgs::CameraInfo_<ContainerAllocator> > {
  ...
  static const char* value(
      const ::sensor_msgs::CameraInfo_<ContainerAllocator>&) {
    return value();
  }
...
struct HasHeader< ::sensor_msgs::CameraInfo_<ContainerAllocator> >
    : public TrueType {};
template <class ContainerAllocator>
struct HasHeader<const ::sensor_msgs::CameraInfo_<ContainerAllocator> >
    : public TrueType {};
}  // namespace message_traits
}  // namespace ros
...
struct Printer< ::sensor_msgs::CameraInfo_<ContainerAllocator> > {
  ...
  static void stream(Stream& s,
    ...
    s << indent << "header: ";
    s << std::endl;
    Printer< ::std_msgs::Header_<ContainerAllocator> >::stream(
        s, indent + "  ", v.header);
    s << indent << "height: ";
    ...
    s << indent << "roi: ";
    s << std::endl;
    Printer< ::sensor_msgs::RegionOfInterest_<ContainerAllocator> >::stream(
        s, indent + "  ", v.roi);
  }
};
