 ...
 * /tmp/buildd/ros-diamondback-common-msgs-1.4.0/debian/ros-diamondback-common-msgs/opt/ros/diamondback/stacks/common_msgs/sensor_msgs/msg/Image.msg
 */
...
struct Image_ : public ros::Message {
  ...
  ROS_DEPRECATED void get_data_vec(
      std::vector<uint8_t,
                  typename ContainerAllocator::template rebind<uint8_t>::other>&
          vec) const {
    vec = this->data;
  }
  ROS_DEPRECATED void set_data_vec(
      const std::vector<
          uint8_t,
          typename ContainerAllocator::template rebind<uint8_t>::other>& vec) {
    this->data = vec;
  }
...
";
 ...
 public:
  ...
  typedef boost::shared_ptr< ::sensor_msgs::Image_<ContainerAllocator> const>
      ConstPtr;
};  // struct Image
...
std::ostream& operator<<(std::ostream& s,
  ...
  ros::message_operations::Printer<
      ::sensor_msgs::Image_<ContainerAllocator> >::stream(s, "", v);
  return s;
}
...
struct HasHeader< ::sensor_msgs::Image_<ContainerAllocator> >
    : public TrueType {};
template <class ContainerAllocator>
struct HasHeader<const ::sensor_msgs::Image_<ContainerAllocator> >
    : public TrueType {};
}  // namespace message_traits
}  // namespace ros
